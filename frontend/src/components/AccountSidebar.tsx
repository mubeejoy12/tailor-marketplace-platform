...
import { User, ShoppingBag, Ruler, LayoutDashboard, MessageSquare, ShieldCheck, Shield, BarChart2, Scissors } from "lucide-react";
...
const BASE_NAV = [
  ...
  { href: "/profile/shop", label: "Shop Profile",  icon: Scissors,    roles: ["TAILOR"] },
